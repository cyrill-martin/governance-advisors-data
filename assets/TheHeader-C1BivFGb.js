import{o as Pe,a as Z,r as k,b as Ne,w as he,d as fe,c as w,e as x,f as i,g as W,h as We,i as c,m as me,u as J,j as U,k as y,l as ge,n as G,p as Ae,s as je,q as K,F as Le,T as be,S as ve,v as te,t as pe,x as Q,y as Ue,z as Xe,A as Ye,B as L,C as Ve,D as qe,E as Ge,G as X,H,I as Ke,J as Ze,L as Je,K as Qe,M as oe,N as re,O as et,P as I,Q as tt,R as ot,U as we,V as ye,W as f,_ as rt,X as nt,Y as O,Z as P,$ as R,a0 as ne,a1 as it,a2 as M,a3 as st}from"./index-BIYw4bmJ.js";const at=typeof document<"u"&&typeof window<"u",ee=k(!1);function ie(){ee.value=!0}function se(){ee.value=!1}let N=0;function lt(){return at&&(Pe(()=>{N||(window.addEventListener("compositionstart",ie),window.addEventListener("compositionend",se)),N++}),Z(()=>{N<=1?(window.removeEventListener("compositionstart",ie),window.removeEventListener("compositionend",se),N=0):N--})),ee}let F=0,ae="",le="",de="",ce="";const ue=k("0px");function dt(e){if(typeof document>"u")return;const t=document.documentElement;let o,a=!1;const d=()=>{t.style.marginRight=ae,t.style.overflow=le,t.style.overflowX=de,t.style.overflowY=ce,ue.value="0px"};Ne(()=>{o=he(e,l=>{if(l){if(!F){const r=window.innerWidth-t.offsetWidth;r>0&&(ae=t.style.marginRight,t.style.marginRight=`${r}px`,ue.value=`${r}px`),le=t.style.overflow,de=t.style.overflowX,ce=t.style.overflowY,t.style.overflow="hidden",t.style.overflowX="hidden",t.style.overflowY="hidden"}a=!0,F++}else F--,F||d(),a=!1},{immediate:!0})}),Z(()=>{o?.(),a&&(F--,F||d(),a=!1)})}function ct(e){const{textColorBase:t,opacity1:o,opacity2:a,opacity3:d,opacity4:l,opacity5:r}=e;return{color:t,opacity1Depth:o,opacity2Depth:a,opacity3Depth:d,opacity4Depth:l,opacity5Depth:r}}const ut={common:fe,self:ct},ht=w("icon",`
 height: 1em;
 width: 1em;
 line-height: 1em;
 text-align: center;
